...
class MapNode implements Comparable<MapNode>
{
	...
	private double estimtedDistance;
	...
	public void setNodeWeight(double w){
		nodeWeight=w;
	}
	
	public void setEstimatedDistance(GeographicPoint goal){
		
		if(goal==null) {
			estimtedDistance=0.0; 
		}
		
		else {
			estimtedDistance=location.distance(goal);
		}
	}
	
	public double getEstimatedDistance(){
		return estimtedDistance;
	}
	...
	public int compareTo(MapNode o) {
		if(this.getNodeWeight()+this.getEstimatedDistance()<o.getNodeWeight()+o.getEstimatedDistance()) {
			return -1;
		}
		else if(this.getNodeWeight()+this.getEstimatedDistance()>o.getNodeWeight()+o.getEstimatedDistance()){
			return 1;
		}
		return 0;
	}
